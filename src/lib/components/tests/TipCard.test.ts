...
describe('TipCard', () => {
	it('should render the correct plant type name and description', () => {
		...
		const description = getByText(
			'Bonsai trees require regular pruning and care to maintain their small size and unique shape. Consider using specialized bonsai soil, fertilizer, and tools to help your bonsai thrive.'
		);
