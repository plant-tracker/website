...
<div class="container mx-auto max-w-screen-xl p-4 md:p-10">
	<div class="flex gap-10">
		<div class="w-2/3 flex flex-col gap-6 justify-center">
				...
				<div class="flex flex-row gap-4 items-center">
					...
					<div class="flex flex-col">
						<h1 class="text-4xl font-bold">
							<span
								class="bg-gradient-to-br from-teal-200 to-cyan-600 bg-clip-text text-transparent box-decoration-clone"
								>Plant Tracker</span
							>
						</h1>
			...
			<h2>Statistics</h2>
			<div class="logo-cloud grid-cols-2 gap-1">
				<div class="logo-item">
			...
			<div class="flex flex-col justify-center gap-3">
				<div class="card flex flex-row p-2 gap-2">
					...
					<div class="flex flex-col gap-2">
						<span>Don't want to miss any notifications?</span>
						<div class="flex flex-col gap-2">
